...
const directoryPath = path.join(process.env.GITHUB_WORKSPACE, 'docs/_includes/motion-templates');
const outputFile = path.join(process.env.GITHUB_WORKSPACE, 'docs/_includes/generated-motion-templates.md');
