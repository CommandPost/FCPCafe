...
const directoryPath = path.join(process.env.GITHUB_WORKSPACE, 'docs/_includes/developer-tools-and-frameworks');
const outputFile = path.join(process.env.GITHUB_WORKSPACE, 'docs/_includes/generated-developer-tools-and-frameworks.md');
...
try {
    fs.readdir(directoryPath, function (err, files) {
        ...
        files.forEach(function (file) {
            ...
            fileContent += `{{ include "developer-tools-and-frameworks/${fileNameWithoutExtension}" }}\n\n---\n\n`;
        });
