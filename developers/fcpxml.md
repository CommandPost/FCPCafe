...
You can read a detailed FCPXML Format Reference document over on the [FCPBridge GitHub](https://github.com/elliotttate/FCPBridge/blob/main/docs/FCPXML_FORMAT_REFERENCE.md).
