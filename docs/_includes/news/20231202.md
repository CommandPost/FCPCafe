...
The fact that you can now import **iMovie for iOS** projects into Final Cut Pro for iPad might be a hint that Mac to iPad is also on their radar/wish-list.
...
[Some users have reported](https://twitter.com/Alex4D/status/1730929760962777529) that Final Cut Pro thinks a QWERTY keyword is attached, when instead a AZERTY keyword is.

I've been able to make it crash using third party Audio Units.
