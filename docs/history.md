...
The story begins with **Randy Ubillos**, a name widely associated with the creation of the first three versions of [Adobe Premiere Pro](https://www.adobe.com/products/premiere.html){target="_blank"}. His team's knack for developing professional video editing programs was then recognized by Macromedia, leading them to embark on a new project, **KeyGrip**.

KeyGrip was a more professional video editing program, built on Apple's [QuickTime](https://www.apple.com/quicktime/){target="_blank"}, which was intended for Macromedia's portfolio. However, due to licensing issues with Truevision, and Macromedia's shift towards web market solutions, the project hit a roadblock. Macromedia decided to sell its desktop applications, including the embryonic KeyGrip.

#### Birth of the Final Cut Pro

In a pivotal year of 1998, KeyGrip was renamed _Final Cut_, and showcased as a 0.9 alpha version at the [NAB Show](https://www.nabshow.com/){target="_blank"}. With no buyers, Apple, recognizing the potential of the software, stepped in and acquired the development team.
...
In 2011, Apple launched a major new iteration of its popular video editing software - [Final Cut Pro X](https://www.apple.com/final-cut-pro/){target="_blank"}. This version represented a significant departure from its predecessors, bringing both praise and criticism for its novel approach.

#### The Launch and Initial Response

The launch of [Final Cut Pro X](https://www.apple.com/final-cut-pro/){target="_blank"} (also known as FCPX or FCP 10) in June 2011, stirred up quite a controversy within the industry. The significant changes implemented by Apple shook many long-time users. Some of the main points of contention were the lack of backward compatibility with projects from previous versions and the initial absence of features like multi-cam editing and the ability to edit tape-based media.
...
To gain an idea of the extent of the initial backlash, you can watch [Conan O'Brien's satirical response](https://www.youtube.com/watch?v=KnapaZYD2cU){target="_blank"} on his talk show.

#### Behind the Scenes

Phil Pan on [Alex4D's Facebook Group](https://www.facebook.com/Alex4D/posts/2875905815768477?comment_id=2878510342174691&comment_tracking=%7B%22tn%22%3A%22R%22%7D){target="_blank"}, from the development team reveals that much of the advanced work from the core Shake team during this time was focused on the Helium renderer, a technology that is still central to Apple's Pro Apps today.
...
A significant contribution was the [Magnetic Timeline](https://support.apple.com/guide/final-cut-pro/use-the-magnetic-timeline-veroedf7a86e/mac){target="_blank"}, which allowed for fluid, flexible editing, simplifying the process of exploring story ideas. Additionally, the introduction of [Compound Clips](https://support.apple.com/guide/final-cut-pro/create-compound-clips-vere6f9d6b8/mac){target="_blank"} further streamlined complex projects.
...
Further solidifying its place within the industry is the introduction of [ProRes RAW](https://www.apple.com/final-cut-pro/docs/Apple_ProRes_RAW_White_Paper.pdf){target="_blank"} in FCPX, making it a go-to tool for many professionals. This format combines the flexibility of RAW video with the incredible performance

#### Final Cut Pro for iPad: Expanding Horizons

In an exciting move, Apple announced in May 2023 the availability of [Final Cut Pro for iPad](https://www.apple.com/newsroom/2023/05/apple-brings-final-cut-pro-and-logic-pro-to-ipad/){target="_blank"}, further expanding the reach and versatility of this beloved editing software. The launch date was 23rd May 23 2023.

This iPad version requires an M-series chip, a powerhouse in Apple's lineup of [Apple Silicon](https://en.wikipedia.org/wiki/Apple_silicon#M_series){target="_blank"}. This move allows users to make full use of the advanced capabilities and power efficiency that the M-series chips offer.
