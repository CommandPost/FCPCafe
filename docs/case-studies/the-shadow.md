...
![Screenshot of Finder structure, dedicated folders for Masterclips, FCP original Media Folder. Every Editor has it’s own folder for additional footage](/static/the-shadow-8.jpg)
...
To complement the flood of footage and keep 4 Editors in the loop about the shooting schedule we use [notion.so](http://notion.so){target="_blank"}. (credit to [Knut Hake](https://twitter.com/knurrrrrrt){target="_blank"} for finding this!) It’s like a bulletin board in the cloud with flexible views.
