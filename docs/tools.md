...
Expand your abilities with a wide supply of effects, plug-ins & templates for Final Cut Pro & Apple Motion.
...
Links to resources for [Support](https://support.fxfactory.com){target="_blank"} & [Development](https://fxfactory.com/developer/){target="_blank"}
