...
The FCP Cafe **icon** was designed by the amazing [Matthew Skiles](https://matthewskiles.com){target="_blank"}.

You can download a **Desktop Wallpaper** version of it [here](https://fcp.cafe/static/FCP-Cafe-Wallpaper.png){target="_blank"}.
